          ...
          <div className="kbnLoaderWrap">
            ...
            <div
              ...
              data-error-message={i18n('core.ui.welcomeErrorMessage', {
                defaultMessage:
                  'VOZIQ BI did not load properly. Check the server output for more information.',
              })}
            >
              {i18n('core.ui.welcomeMessage', { defaultMessage: 'Loading VOZIQ BI' })}
            </div>
        ...
        <div className="kbnWelcomeView" id="kbn_legacy_browser_error" style={{ display: 'none' }}>
          ...
          <div className="kbnWelcomeText">
            {i18n('core.ui.legacyBrowserMessage', {
              defaultMessage:
                'This VOZIQ BI installation has strict security requirements enabled that your current browser does not meet.',
            })}
          </div>
        </div>
