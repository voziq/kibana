...
import { HeatmapDnVisParams } from '../../../heatmap_dn';


function HeatMap_dnOptions(props: VisOptionsProps<HeatmapDnVisParams>) {
  ...
  return (
    <>
      ...
      />
        ...
        paramName="showLegend"
			
			value={stateParams.showLegend}
        setValue={setValue}
      />
	   ...
	   <SwitchOption
        ...
        paramName="showNumber"
			
			value={stateParams.showNumber}
        setValue={setValue}
      />
	  ...
	  <SelectOption
		...
		options={vis.type.editorConfig.collections.ranges}
        paramName="range"
        ...
        setValue={setValue}
			/>
			   ...
			   <SwitchOption
        label={i18n.translate('visTypeVislib.controls.gaugeOptions.showLabelsLabel', {
          defaultMessage: 'Set Buckets Range',
        })}
        paramName="setMaxMin"
