...
import { CalenderheatmapVisParams } from '../../../calenderheatmap';


function CalenderheatmapOptions(props: VisOptionsProps<CalenderheatmapVisParams>) {
