...
export const createPoolcurveVisTypeDefinition = (deps: VisTypeVislibDependencies) => ({
  name: 'poolcurve',
  title: i18n.translate('visTypeVislib.line.lineTitle', { defaultMessage: 'Pool Curve' }),
  icon: 'visLine',
  description: i18n.translate('visTypeVislib.line.lineDescription', {
    defaultMessage: 'Pool Curve',
  }),
    ...
    schemas: new Schemas([
      {
        ...
        name: 'metric',
        title: i18n.translate('visTypeVislib.line.metricTitle', { defaultMessage: 'Axis' }),
        min: 1,
