 ...
 * Date: 2016-06-05
 */
 //import d3.chart from 'ui/vislib/lib/d3.chart.min';
! function(t, e) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = e(require("d3"), require("./d3.chart"));//ui/vislib/lib/
    /* else if ("function" == typeof define && define.amd) define(["d3", "d3.chart"], e);//ui/vislib/lib/ */
    else {
        var n = "object" == typeof exports ? e(require("d3"), require("./d3.chart")) : e(t.d3, t.d3.chart);//ui/vislib/lib/
                ...
                i.d3.sankey = s(), i.d3.path = i.d3.sankey.link(), i.d3.sankey.size([i.features.width, i.features.height]), i.features.spread = !1, i.features.iterations = 32, i.features.nodeWidth = i.d3.sankey.nodeWidth(), i.features.nodePadding = i.d3.sankey.nodePadding(), i.features.alignLabel = "auto", i.layers.links = i.layers.base.append("g").classed("links", !0), i.layers.nodes = i.layers.base.append("g").classed("nodes", !0), i.on("change:sizes", function() {
                    ...
                    events: {
                        ...
                        merge: function() {
                            ...
                            }), this.select("rect").attr("height", function(t) {if(t.dy >0)
                            	{return t.dy}else{return 0}
