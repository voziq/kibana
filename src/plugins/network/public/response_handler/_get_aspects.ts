...
import { makeFakeXAspect } from '../../../vis_type_vislib/public/vislib/helpers/point_series/_fake_x_aspect';
import { Dimensions, Aspects } from '../../../vis_type_vislib/public/vislib/helpers/point_series/point_series';
import { Table } from '../../../vis_type_vislib/public/vislib/types';
...
export function getAspects(table: Table, dimensions: Dimensions) {
  ...
  (Object.keys(dimensions) as Array<keyof Dimensions>).forEach((name) => {
    ...
    /* if(name == 'y' && dimensionList.length == 0){
